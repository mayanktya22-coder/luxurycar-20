...
export default function Index() {
  const featuredCars = [
    {
      image:
        "https://images.unsplash.com/photo-1617469767537-b85ba699fcb6?w=800&h=600&fit=crop",
      name: "Phantom IX",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1494976866165-199999999999?w=800&h=600&fit=crop",
      name: "Zenith EV",
      category: "Electric",
      specs: [
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Hand-selected vehicles representing the pinnacle of automotive excellence and craftsmanship.",
    },
    {
      icon: Sparkles,
      title: "Bespoke Service",
      description:
        "Personalized concierge experience tailored to your preferences and lifestyle.",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Access to the latest luxury and performance technologies before they're widely available.",
    },
  ];
  ...
  const carCategories = [
    {
      title: "Luxury Sedans",
      image:
        "https://images.unsplash.com/photo-1617469767537-b85ba699fcb6?w=400&h=300&fit=crop",
      description:
        "Experience refined comfort and timeless elegance with our premium sedan collection.",
    },
    {
      title: "Performance",
      image:
      ...
      description:
        "Push the limits with cutting-edge performance and exhilarating acceleration.",
    },
    {
      title: "Electric Future",
      image:
        "https://images.unsplash.com/photo-1560958089-b8a46dd52919?w=400&h=300&fit=crop",
      description:
        "Sustainable luxury with zero emissions and unprecedented efficiency.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Curated collection of the world's most exclusive automobiles.
                  Where luxury meets innovation, and every drive tells a story
                  of craftsmanship.
                </p>
              </div>
            ...
            {/* Hero Image */}
            <div
              className="relative h-96 md:h-full animate-fade-in"
      ...
      <section
        id="collection"
        className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-card/50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Three distinct categories of excellence, each representing the
      ...
      <section id="featured" className="py-20 md:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Handpicked masterpieces from our exclusive inventory, carefully
              selected for their exceptional qualities.
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              More than vehicles—a gateway to a lifestyle of uncompromising
              excellence and refined elegance.
            </p>
          </div>
      ...
      <section
        id="schedule"
        className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-accent/10 via-transparent to-accent/5"
      >
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground">
              Schedule a personalized test drive and experience the
              extraordinary on the road. Our concierge team is ready to serve
              you.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The ultimate destination for exclusive luxury and performance
                vehicles.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <a
                    href="mailto:hello@luxemotors.com"
                    className="hover:text-accent transition-colors"
                  >
